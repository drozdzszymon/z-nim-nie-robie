...
export default function App() {
  ...
  const guestToggleNode = (
    ...
    >
      <Text style={[styles.toggleText, isCompactSettingsUI && styles.toggleTextCompact, newIsGuest && styles.guestToggleTextActive]}>
        {t('guest', lang)}
      </Text>
    </TouchableOpacity>
  );
...
const styles = StyleSheet.create({
  ...
  controlPanelCompact: { padding: 16, borderRadius: 16, marginBottom: 14 },
  controlPanelAccent: {
    position: 'absolute',
    top: 0,
    left: 0,
  ...
  controlPanelHeader: { marginBottom: 20 },
  controlPanelHeaderCompact: { marginBottom: 14 },
  controlPanelEyebrow: { color: COLORS.textMuted, fontSize: 10, fontWeight: '500', letterSpacing: 1.4, marginBottom: 8, textTransform: 'uppercase', opacity: 0.7 },
  controlPanelTitle: { color: COLORS.textPrimary, fontSize: 22, fontWeight: '500', letterSpacing: -0.2 },
  controlPanelTitleCompact: { fontSize: 17 },
  controlPanelSubtitle: { color: COLORS.textMuted, fontSize: 13, fontWeight: '400', lineHeight: 20, marginTop: 6, maxWidth: 360, opacity: 0.85 },
  controlPanelSubtitleCompact: { fontSize: 12, lineHeight: 17, marginTop: 4, maxWidth: 290 },
  ...
  controlSummaryBadgeCompact: { paddingVertical: 4, paddingHorizontal: 9 },
  controlSummaryBadgeNeutral: {
    backgroundColor: 'rgba(255,255,255,0.04)',
    borderColor: 'transparent',
  },
  controlSummaryBadgeText: { color: COLORS.textPrimary, fontSize: 11, fontWeight: '500', letterSpacing: 0.6 },
  controlSummaryBadgeTextCompact: { fontSize: 10.5 },
  fieldBlock: { marginBottom: 18 },
  fieldBlockCompact: { marginBottom: 14 },
  ...
  fieldLabelBadge: { color: COLORS.textMuted, fontSize: 10, fontWeight: '500', letterSpacing: 1.4, marginBottom: 10, textTransform: 'uppercase', opacity: 0.7 },
  optionGroup: { marginBottom: 18 },
  optionGroupCompact: { marginBottom: 14 },
  optionGroupLabel: { color: COLORS.textMuted, fontSize: 10, fontWeight: '500', letterSpacing: 1.4, marginBottom: 10, textTransform: 'uppercase', opacity: 0.7 },
  ...
  inputTextCompact: { fontSize: 15, paddingHorizontal: 14, paddingVertical: 12, borderRadius: 10 },
  ...
  toggleBtnCompact: { minHeight: 40, paddingHorizontal: 8, paddingVertical: 8, borderRadius: 10 },
  toggleText: { color: COLORS.textSecondary, fontWeight: '500', fontSize: 13, letterSpacing: 0.2 },
  ...
  addButtonCompact: { paddingVertical: 12, borderRadius: 12, marginTop: 2 },
  addButtonText: { color: COLORS.bgMain, fontWeight: '600', fontSize: 15, letterSpacing: 0.6 },
  addButtonTextCompact: { fontSize: 13.5, letterSpacing: 0.4 },
  ...
  timeCardCompact: { padding: 10, borderRadius: 12 },
  timeCardLabel: { color: COLORS.textMuted, fontSize: 10, fontWeight: '500', letterSpacing: 1.4, marginBottom: 10, textTransform: 'uppercase', opacity: 0.7 },
  timeCardLabelCompact: { fontSize: 9.5, marginBottom: 7 },
  timeCardInput: {
  ...
  timeCardInputCompact: { fontSize: 18, paddingVertical: 7, borderRadius: 9 },
  ...
  vipButtonCompact: { minHeight: 44, paddingVertical: 9, paddingHorizontal: 10, borderRadius: 10 },
  vipButtonActive: { backgroundColor: COLORS.accentMain, borderColor: COLORS.accentMain },
  vipButtonText: { color: COLORS.textSecondary, fontSize: 13, fontWeight: '500', textAlign: 'center', letterSpacing: 0.3 },
  vipButtonTextCompact: { fontSize: 12 },
  ...
  startButtonCompact: { paddingVertical: 14, borderRadius: 12, marginTop: 2 },
  startButtonText: { color: COLORS.bgMain, fontSize: 17, fontWeight: '600', letterSpacing: 0.8 }, 
  startButtonTextCompact: { fontSize: 15 },
